...
pub use ffi::{
    ...
    net_destroy, iterm_get_id, inst_get_id, layer_find_v55_spacing, layer_min_area, tech_via_boxes, tech_via_layer, bpin_layer_boxes, num_cut_spacing_table_rules, cut_spacing_table_max_spacing, cut_spacing_table_spacing, cut_spacing_table_is_center_and_edge, cut_spacing_table_is_center_to_center, techvialayerrule_rect, via_create_generated, swire_add_via, swire_add_box, swire_add_box_shaped, swire_clear_routed, bterm_create, bterm_create_pin, layer_get_type,
